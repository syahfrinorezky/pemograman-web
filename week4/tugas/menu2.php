...
<body class="bg-[#303030]">
    <header class="absolute w-full bg-neutral-800 text-slate-100 flex flex-col justify-center items-center p-6">
        ...
        <nav class="mt-5">
            <ul class="flex">
                ...
                <li class="text-yellow-500 flex items-center justify-center underline border-r border-white px-3"><a href="./menu3.php">Link3</a></li>
    ...
    <main class="h-screen flex items-center justify-center text-white">
        <p>Ini adalah isi dari halama link 2</p>
    </main>
